...
public class ServiciosAlquilerItemsStub implements ServiciosAlquiler {
   ...
   private void poblar() {
       ...
       Cliente c1=new Cliente("David Perez", 1193427928, "7770010", "KRA 96A# 152 -85", "david.perez-m@escuelaing.edu.co", false,list1);
       Cliente c2=new Cliente("Nicolas Camacho", 1026594432, "32203033", "CL 23 BIS # 28 -63", "nicolas.camacho-h@escuelaing.edu.co", false,list2);
       Cliente c3=new Cliente("Ronaldo Nazario", 1026585669, "4457863", "KRA 103#94-a77", "ronaldo@hotmail.com", false,list3);
